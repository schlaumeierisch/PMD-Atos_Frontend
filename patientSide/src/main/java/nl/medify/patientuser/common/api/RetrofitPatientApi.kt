...
class RetrofitPatientApi {
    companion object {
        ...
        /**
         * @return [PatientAPIService] The service class off the retrofit client.
         */
        private fun createApi(): PatientAPIService {
            ...
            return patientApi.create(PatientAPIService::class.java)
        }
    }
}