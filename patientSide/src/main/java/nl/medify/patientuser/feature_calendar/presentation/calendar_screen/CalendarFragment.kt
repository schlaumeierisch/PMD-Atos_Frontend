...
import nl.medify.patientuser.databinding.FragmentCalendarBinding
...
class CalendarFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        loginViewModel.loggedInPatient?.let { calendarViewModel.getAllAppointmentsOfPatient(it.id) }
