...
import nl.medify.patientuser.databinding.FragmentAddingNoteBinding
...
class AddNoteFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAddingNoteBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun openConfirmationDialog(
        ...
        dialogOkSureBtn.setOnClickListener {
            ...
            noteViewModel.postCreateNote(
                noteTitle,
                noteDescription,
                loginViewModel.loggedInPatient!!.medicalRecordId
            )
